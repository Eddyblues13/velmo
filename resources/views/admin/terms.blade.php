...
<div class="main-panel bg-light">
    <div class="content bg-light">
        <div class="page-inner">
            <div class="mt-2 mb-4">
                <h1 class="title1 text-dark">Terms and Privacy Policy</h1>
            </div>
            <div>
            </div>
            <div>
            ...
            <div class="mb-5 row">
                <div class="col-md-12">
                    <div class="card p-1 p-md-5 shadow-lg bg-light text-dark">
                        <div class="row">
                            <div class="mb-3 col-md-12">
                                <form method="post"
                                    action="https://lockestocks.com/account/admin/dashboard/privacy-policy">
                                    <input type="hidden" name="_token" value="s195WfZZZJb3SUAWuuGNZ9Eo2OT4S0jZ1ogZrdon">
                                    <div class="form-group">
                                        <h5 class="text-dark">Use Terms and Privacy Policy?</h5>
                                    ...
                                    <div class="form-group">
                                        <textarea class="ckeditor form-control bg-light text-dark" name="termsprivacy">
